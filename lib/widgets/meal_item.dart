...
class MealItem extends StatelessWidget {
  const MealItem(
      {super.key, required this.mealItem, required this.selectedMeal});
  ...
  String get complexityText {
    return mealItem.complexity.name[0].toLowerCase() +
        mealItem.complexity.name.substring(1);
  }

  String get affordabilityText {
    return mealItem.affordability.name[0].toLowerCase() +
